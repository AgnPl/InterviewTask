...
public class PageMethods {
    ...
    Logger LOGGER = Logger.getLogger(PageMethods.class.getName());

    final static String WEBSHOP_URL = "https://www.demoblaze.com/index.html";
    final static String LOGIN = "TestingAccount";
    final static String PASSWORD = "Test123!";
    final static String NAME = "Agnieszka";
    final static String COUNTRY = "Poland";
    final static String CITY = "Wroclaw";
    final static String CREDIT_CARD = "1234567890123456789";
    final static String MONTH = "May";
    final static String YEAR = "2026";
